...
- Causality: The study's observational nature prevents us from establishing causality between participation in the 'Responding to GBV' curriculum and improvements in the associated domains. Without an experimental approach, it may be more challenging to establish the validity and reliability of the evaluation results. There may be concerns around selection bias, measurement bias, and other threats to internal validity that can impact the accuracy and generalizability of the findings. However, an experimental approach, such as a randomized control trial, was outside the scope of this project.
