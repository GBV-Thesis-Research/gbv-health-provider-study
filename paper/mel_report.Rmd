...
- Data on Attendance: The absence of individual-level data on attendance at learning labs hinders a thorough assessment of its impact on knowledge and confidence scores. A dose-response relationship between the number of learning labs attended and the improvement on knowledge and confidence scores has yet to be established.
...
- Counterfactual: Given the intent and scope of this project, a control group was not feasible. The lack of a counterfactual group makes it challenging to attribute all observed improvements in knowledge and confidence scores solely to the curriculum. However, given the absence of other GBV-focused interventions in Timor-Leste, it is unlikely another educational intervention would have caused the observed improvement.

Despite these limitations, the study offers valuable insights into the impact of the 'Responding to GBV' curriculum on healthcare providers' knowledge, confidence, and practices in responding to GBV in Timor-Leste. 
