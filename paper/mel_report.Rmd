...
```{r}
outcome5_table %>%
  modify_caption("**Table 4. Outcome 5: Mean Provider Confidence Score by Facility Catchment Area**")
...
```{r}
outcome7_table %>%
  modify_caption("**Table 5. Outcome 7: Provider Practices in Identifying and Caring for Victims of GBV**")
