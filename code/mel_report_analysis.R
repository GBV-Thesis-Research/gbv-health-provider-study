...
# Create Tables
outcome4_columns <- names(regional_scores_median)[grep("outcome4", names(regional_scores_median))]
outcome_4_table <-
  regional_scores_median %>%
...
outcome5_columns <- names(regional_scores_median)[grep("outcome5", names(regional_scores_median))]
outcome_5_table <-
  regional_scores_median %>%
