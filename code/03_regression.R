...
plot.domains <- data.table(
  domain = c(
    "attitudes_12", "attitudes_14",
...
exclusions <- exclusions[domain %in% c(
  "attitudes_12", "attitudes_14",
  "confidence_16", "knowledge_8",
  "system_support_15"
)]
...
maps <- data.table(
  variable = c(
    "female", "age_35older", "position_Nurse", "position_Midwife", "position_Other", "municipality_liquica", "as.factor(training_date)2021-09",
